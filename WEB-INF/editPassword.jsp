...
<head>
    <style type="text/css">
        ...
        .treaty2{ display:block; width:28px; height:50px;margin-left:80%; background:url(static/img/UP.png);_background:none;
            _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="static/img/UP.png");}
...
<div class="content">
    <div style=" width:400px;margin:auto; border:1px solid #eee; overflow:auto; zoom:1;">
        <form  id="regist" action="editPassword" name="regist" method="post">
            <h1>重置密码</h1>
            <dl>
                <dt> 密码</dt>
                <dd><input class="ipt"  type="password" name="passWord" id="passWord" onfocus="this.style.border='2px solid #f60';"  onblur="this.style.border='2px solid #F08300';" />
                    <span style="color: red">${spassword}</span> <div style="margin-top: 10px" class="tipinfo"></div>
                    <input class="ipt"  type="hidden" name="userId" value="${userId}"/>
                </dd>
            </dl>
            <dl>
                <dt>确认密码</dt>
                <dd><input class="ipt" type="password"  name="passWordAgain" id="passWordAgain"onfocus="this.style.border='2px solid #f60';"  onblur="this.style.border='2px solid #F08300';"  />
                    <span style="color: red">${spassword2}</span><div style="margin-top: 10px" class="tipinfo"></div>
                </dd>
            </dl>
            <dl style=" padding:30px 0px 0px 140px;">
