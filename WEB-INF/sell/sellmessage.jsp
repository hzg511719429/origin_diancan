...
<div class="content2"  style=" border-top:none;">
    <div class="menu-content" style="margin-top:50px; margin-left: 20%">
        <form action="messageOrder" onsubmit="return checkForm1()" method="post">
            ...
            <textarea id="txs"  readonly="readonly" name="orderComments" rows="10" style="font-size: 16px" cols="100">${orders.orderComments} </textarea>
            <div>
                <c:if test="${action!=2}">
                ...
                <a  href="sellOrderList" style="color:#fff;">
